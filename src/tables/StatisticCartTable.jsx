    ...
    <>
        ...
        <Table
             ...
             >
                 <TableHead>
                     <TableRow>
                         <TableCell sx={{ width: "22%", top: "64px", fontSize: "18px" }}>Trạng thái</TableCell>
                         <TableCell align="center" sx={{ width: "20%", top: "64px", fontSize: "18px" }}>Số lượng đơn hàng&nbsp;</TableCell>
                     </TableRow>
                 </TableHead>
                 <TableBody>
                         <TableRow
                         ...
                         >
                             ...
                             <TableCell align="center">{props.data["DELIVERIED"] || 0}</TableCell>
                         </TableRow>
                         <TableRow
                             sx={{ "&:last-child td, &:last-child th": { border: 0 } }}
                         >
                             <TableCell align="left">Đã hủy</TableCell>
                             <TableCell align="center">{props.data["CANCELLED"] || 0}</TableCell>
                         </TableRow>
                 </TableBody>
             </Table>
        </Row>
